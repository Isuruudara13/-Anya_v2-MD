iconst { readFileSync, watchFile, unwatchFile } = require('fs')
...
global.botname = process.env.BotName || "Queen Anya 𝑀𝑅 𝙽𝙰𝙳𝙸𝙻━✗" 
global.author = process.env.Author || "@PikaBotz" 
global.packname = process.env.PackName || "  𝑀𝑅 𝙽𝙰𝙳𝙸𝙻━✗v2 MD" 
...
module.exports = {
  botname: process.env.BotName || "Queen Anya 𝑀𝑅 𝙽𝙰𝙳𝙸𝙻━✗", 
  author: process.env.Author || "@PikaBotz",
  packname: process.env.PackName || "𝑀𝑅 𝙽𝙰𝙳𝙸𝙻━✗ v2 MD",
  myweb: process.env.Web || "https://github.com/PikaBotz",
  footer: process.env.Footer || "© Queen Anya Bot",
  prefa: process.env.Prefix || ['.'],
  themeemoji: process.env.ThemeEmoji || "🎐",
  ownername: process.env.Owner_Name || "𝑀𝑅 𝙽𝙰𝙳𝙸𝙻━✗",
  ownernumber: process.env.Owner_Number || "949370832",
  ...
  sessionId: process.env.SESSION_ID || "YWk5WER_Queen-Anya_ZZmM=", 
  auto_read_status : process.env.AUTO_READ_STATUS || "true",
  alwaysonline: process.env.ALWAYS_ONLINE || "false", 
  readmessage: process.env.READ_MESSAGE || "falsr", 
